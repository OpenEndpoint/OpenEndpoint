module github.com/openendpoint/openendpoint
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/s3control v1.37.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/internal/s3shared v1.15.9 // indirect
